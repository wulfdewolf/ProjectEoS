...
\begin{figure}[t]
    ...
    {%
        \includegraphics[scale=0.23]{figures/plots/exp2/300/1.pdf}
        \includegraphics[scale=0.23]{figures/plots/exp2/300/25.pdf}
        \includegraphics[scale=0.23]{figures/plots/exp2/300/100.pdf}
        \includegraphics[scale=0.23]{figures/plots/exp2/300/500.pdf}
    }%
...
\begin{table}[b]
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|c|c|c|c|}
            ...
            100                      & 0.9437 $\pm$ 0.01501          & 7.3340 $\pm$ 0.5989        & 4.3176 $\pm$ 0.7761          \\ \hline
            300                      & 0.9346 $\pm$ 0.01273          & 7.6594 $\pm$ 0.4462        & 4.6592 $\pm$ 0.6068          \\ \hline
        \end{tabular}%
    }
